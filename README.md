...
答：因为Greenluma并不开源(至少我没找到)，最多只能解锁147个是作者写在程序里的硬限制。原因可能是GreenLuma需要将你的游戏伪装成其他游戏的id来骗过Steam的验证，但作者只找到了这么多个能用来替换的免费游戏(所有人都有权访问的)。
...
GreenLuma_2026_x86.dll (版本GreenLuma_2026_1.7.6)
...
[2] 替换dll文件: 将你从官方论坛解压出来的 GreenLuma_2026_x86.dll 文件放入 override 文件夹下，不要改名
